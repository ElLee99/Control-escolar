...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A Proyect Powered By Lix Industries");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication1/Inicio5.0.jpg"))); // NOI18N
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        materias.setBounds(0, 0, 415, 455);
        materias.setVisible(true);
    }//GEN-LAST:event_jMenuItem6ActionPerformed

    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ListadoMaestro maestro =new ListadoMaestro();
        maestro.setBounds(0, 0, 415, 455);
        maestro.setVisible(true);
    }//GEN-LAST:event_jMenuItem5ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ListadoAlumnos alumnos =new ListadoAlumnos();
        alumnos.setBounds(0, 0, 415, 455);
        alumnos.setVisible(true);
    }//GEN-LAST:event_jMenuItem4ActionPerformed

    private void jMenuItem5MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem5MouseReleased
         JOptionPane.showMessageDialog(this, "Despues de realizar cada operación, apriete ACTUALIZAR");
    ...
    private void jMenuItem6MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem6MouseReleased
        JOptionPane.showMessageDialog(this, "Despues de realizar cada operación, aprieta ACTUALIZAR");
